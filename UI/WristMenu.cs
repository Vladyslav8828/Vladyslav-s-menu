using Vladyslav.Backend;
using Vladyslav.UI;
using Vladyslav.Utilities;
using Photon.Pun;
using System;
...
namespace Vladyslav.UI
{
    ...
    */
    ...
    {
        public static string MenuTitle = "Vladyslav`s Menu"; // this is the menu name, you can change it to whatever you want
        ...
        public static List<ButtonInfo> buttons = new List<ButtonInfo> // main
        {
            ...
            new ButtonInfo { buttonText = "Movmovement", method =() => Mods.Movmovement(), enabled = false, toolTip = "Go to Movmovement Mods"},
            new ButtonInfo { buttonText = "Visuals", method =() => Mods.Visual(), enabled = false, toolTip = "Goes to Visual Mods"},
            new ButtonInfo { buttonText = "Category 3", method =() => Mods.Guns(), enabled = false, toolTip = "Go to Category 3!"},
        ...
        {
            new ButtonInfo { buttonText = "Exit Movmovement", method =() => Mods.Movmovement(), enabled = false, toolTip = "Go to Main!"},
            //built in and mad by malachi
        ...
        {
            new ButtonInfo { buttonText = "Exit Visuals", method =() => Mods.Visual(), enabled = false, toolTip = "Go to Main!"},
            //built in and mad by malachi
        ...
        {
            new ButtonInfo { buttonText = "Exit Guns", method =() => Mods.Guns(), enabled = false, toolTip = "Go to Main!"},
            //built in and mad by malachi
